...
import com.taobao.top.pacman.definition.FunctionDefinition;
import com.taobao.top.pacman.definition.VariableReferenceDefinition;

public class SplitDefinition extends FunctionDefinition {
	...
	@Override
	public Function<ActivityContext, Object> toFunction(ActivityDefinition parent, DefinitionValidator validator) {
