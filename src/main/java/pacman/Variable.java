...
import pacman.expressions.Literal;
...
public class Variable extends LocationReference {
	...
	public Variable(String name, Object constValue) {
		this(name, new Literal(constValue));
	}
	...
	public Variable(String name, Function<ActivityContext, Object> expression) {
		this(name, new FunctionValue(expression));
	}
	
	public Variable(String name, ActivityWithResult expression) {
		this(name);
